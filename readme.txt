...
1.2. Пользователями приложения могут быть покупатели, администраторы и менеджеры магазина.
1.3. Приложение обеспечивает удобное управление заказами, продуктами и пользователями для владельца магазина, а также предоставляет удобный интерфейс для покупателей для просмотра товаров и оформления заказов.
...
2.3. Оформление заказа с указанием адреса доставки и способа оплаты.

3. Доменная модель:
3.1. Сущности:
3.1.1. Пользователь (id, username, password, role)
